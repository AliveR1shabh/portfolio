  ...
  return (
    <ReactLenis root>
      ...
      <button
        ...
        className="fixed bottom-12 right-10 w-11 h-11 rounded-full bg-white text-black flex items-center justify-center z-40 shadow-lg hover:scale-110 hover:bg-[#4cf3f6] hover:text-[#003738] transition-transform duration-200">
